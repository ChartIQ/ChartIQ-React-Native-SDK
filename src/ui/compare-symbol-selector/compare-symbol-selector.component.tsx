...
import { ChartSymbol } from '@chartiq/react-native-chartiq';
...
import { navigate } from '../../../screens/landing/home/CustomNavigation';
...
const CompareSymbolSelector = forwardRef<BottomSheetMethods, CompareSymbolSelectorProps>(
  ({ onAdd, onDelete, data }, ref) => {
    ...
    // console.log('compare data ::', Array.from(data.values()));
