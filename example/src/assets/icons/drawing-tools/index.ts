...
const drawingTools = {
  ...
  segment: Segment,
  speedResistanceArc: SpeedResistanceArc,
  speedResistanceLine: SpeedResistanceLine,
  star: Star,
  timeCycle: TimeCycle,
  trioneLevel: TrioneLevel,
  trendLine: TrendLine,
